...
public class ProductDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addToPantryButton = findViewById(R.id.add_to_pantry_button);
    ...
    private void checkIfProductInPantry(String barcode) {
        executorService.execute(() -> {
            ...
            runOnUiThread(() -> PantryActionViewBinder.bind(
                    addToPantryButton,
    ...
    private void removeProductFromPantry(String barcode) {
        ...
        executorService.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                Toast.makeText(this, outcome == PantryOperationResult.RemoveOutcome.REMOVED
    ...
    private void displayProductDetails(ProductWithDetails productDetails, boolean allowAiInsight) {
        ...
        if (ingredientsMissing) {
            ...
            healthScoreTextView.setTextColor(ContextCompat.getColor(this, R.color.score_unknown));
        ...
        if (allowAiInsight && aiEnabled && ingredientsMissing) {
            showMissingIngredientReviewPrompt(productDetails);
            if (aiSummaryContainer != null) aiSummaryContainer.setVisibility(View.GONE);
    ...
    private void displaySources(org.json.JSONArray sources) {
        ...
        CharSequence sourceText = ScientificSourceTextBuilder.build(this, sources);
    ...
    private void showMissingIngredientReviewPrompt(ProductWithDetails product) {
        if (ingredientInputPromptVisible || isFinishing() || isDestroyed()) return;
